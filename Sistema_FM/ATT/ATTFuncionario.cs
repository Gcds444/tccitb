       ...
       //         MessageBox.Show("cpf já utilizado");
         //   }
          ...
          //  {
                ...
                funcionario = new BLL.BLLFuncionarioSql();
                funcionario.AtualizarFuncionarioCPF(txtID.Text, txtNome.Text, dataresumida, txtSexo.Text, txtCPF.Text, txtEmail.Text, txtResidencial.Text, txtMovel.Text, txtCEP.Text, txtLogradouro.Text, txtNumero.Text , txtComplemento.Text, txtBairro.Text, txtCidade.Text, txtUF.Text, txtUsuario.Text, txtSenha.Text, txtFuncao.Text);
        ...
        private void AtualizarAgoraVai()
        {
            funcionario = new BLL.BLLFuncionarioSql();
      //      funcionario.AtualizarFuncionarioCPF(txtID.Text,txtNome.Text, txtDataNasc.Text, txtSexo.Text, txtRG.Text, txtCPF.Text, txtEmail.Text, txtResidencial.Text, txtMovel.Text, txtCEP.Text, txtLogradouro.Text, txtNumero.Text, txtComplemento.Text, txtBairro.Text, txtCidade.Text, txtUF.Text, txtUsuario.Text, txtSenha.Text, txtFuncao.Text);
        ...
        private void txtCPF_MaskInputRejected_1(object sender, MaskInputRejectedEventArgs e)
        {
        ...
        private void btnEncontrar_Click_1(object sender, EventArgs e)
        {
            BuscarCEP();
        }
